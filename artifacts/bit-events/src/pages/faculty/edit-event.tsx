...
const updateEventSchema = z.object({
  ...
  paymentQrUrl: z.string().url("Must be a valid URL").optional().or(z.literal("")).nullable(),
});

export function EditEvent() {
  const [, params] = useRoute("/faculty/events/:id/edit");
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-primary">Edit Event</h1>
      ...
      <Card className="shadow-md border-t-4 border-t-primary">
        <CardHeader className="bg-muted/10 border-b">
          ...
          <CardDescription>Make changes to {event.title}</CardDescription>
        </CardHeader>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <Input placeholder="e.g. HackWeb3.0" className="text-lg" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  {event.imageUrl && !file && (
                    <div className="mb-2">
                      ...
                      <img src={event.imageUrl} alt="Current banner" className="h-32 object-cover rounded-md border" />
                    </div>
                  )}
                  <div className="flex items-center gap-4 border p-4 rounded-lg bg-muted/30">
                    ...
                    >
                      ...
                      {event.imageUrl ? "Change Image" : "Choose Image"}
                    </Button>
              ...
              <div className="flex justify-end gap-4 pt-6 border-t">
                ...
                <Button 
                  ...
                  disabled={updateEventMutation.isPending || uploading}
                  data-testid="button-submit-event"
                >
                  {uploading ? "Uploading Image..." : updateEventMutation.isPending ? "Saving..." : "Save Changes"}
                </Button>
              </div>
            </form>
          </Form>
